...
(define (find-prims ps v)
  (cond
    ...
    [(or (symbol? v) (number? v) (boolean? v) (module-path-index? v) (path? v) (char? v) (void? v) (string? v) (indirect? v) (keyword? v) (regexp? v) (byte-regexp? v) (placeholder? v) (hash-placeholder? v))
     ps]
    [(sequence? v)
     (for/fold ([ps ps])
       ([e v])
